...
function login() {
  ...
  ScatterJS.scatter.connect(dappName).then(connected => {
    ...
    scatter.getIdentity(requiredFields).then(() => {
      ...
      // eos.transfer(account.name, 'eosiomeetone', '0.0001 EOS', 'sent from eos-wallet-integrate', transactionOptions).then(trx => {
      //   // That's it!
